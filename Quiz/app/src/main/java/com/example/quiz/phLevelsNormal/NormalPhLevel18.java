...
import com.example.quiz.databinding.ActivityNormalPhLevel18Binding;
import com.example.quiz.system.ActivityPhNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalPhLevel18 extends BaseActivity {

    private ActivityNormalPhLevel18Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalPhLevel18Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalPhLevel18Ans4, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalPhLevel19.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_NORMAL, 18);
