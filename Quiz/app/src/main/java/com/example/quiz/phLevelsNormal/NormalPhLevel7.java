...
import com.example.quiz.databinding.ActivityNormalPhLevel7Binding;
import com.example.quiz.system.ActivityPhNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalPhLevel7 extends BaseActivity {

    private ActivityNormalPhLevel7Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalPhLevel7Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalPhLevel7Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalPhLevel8.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_NORMAL, 7);
