...
import com.example.quiz.databinding.ActivityNormalBioLevel4Binding;
import com.example.quiz.system.ActivityBioNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalBioLevel4 extends BaseActivity {


    private ActivityNormalBioLevel4Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalBioLevel4Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalBioLevel4Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalBioLevel5.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_BIO_NORMAL, 4);
