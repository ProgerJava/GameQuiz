...
import com.example.quiz.databinding.ActivityHardGeoLevel8Binding;
import com.example.quiz.system.ActivityGeoHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardGeoLevel8 extends BaseActivity {

    private ActivityHardGeoLevel8Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardGeoLevel8Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardGeoLevel8Ans4, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardGeoLevel9.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_HARD, 8);
