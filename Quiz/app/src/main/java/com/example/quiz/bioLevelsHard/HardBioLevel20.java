...
import com.example.quiz.databinding.ActivityHardBioLevel20Binding;
import com.example.quiz.system.ActivityBioHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardBioLevel20 extends BaseActivity {

    private ActivityHardBioLevel20Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardBioLevel20Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardBioLevel20Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, ActivityBioHard.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_BIO_HARD, 20);
