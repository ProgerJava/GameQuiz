...
import com.example.quiz.databinding.ActivityHardPhLevel19Binding;
import com.example.quiz.system.ActivityPhHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardPhLevel19 extends BaseActivity {

    private ActivityHardPhLevel19Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardPhLevel19Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardPhLevel19Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardPhLevel20.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_HARD, 19);
