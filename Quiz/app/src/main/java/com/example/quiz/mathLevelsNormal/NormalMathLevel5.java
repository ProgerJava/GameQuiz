...
import com.example.quiz.databinding.ActivityNormalMathLevel5Binding;
import com.example.quiz.system.ActivityMathematicsNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalMathLevel5 extends BaseActivity {

    private ActivityNormalMathLevel5Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalMathLevel5Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalMathLevel5Ans4, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalMathLevel6.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_NORMAL, 5);
