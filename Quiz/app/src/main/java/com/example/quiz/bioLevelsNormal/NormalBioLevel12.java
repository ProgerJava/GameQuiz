...
import com.example.quiz.databinding.ActivityNormalBioLevel12Binding;
import com.example.quiz.system.ActivityBioNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalBioLevel12 extends BaseActivity {

    private ActivityNormalBioLevel12Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalBioLevel12Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalBioLevel12Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalBioLevel13.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_BIO_NORMAL, 12);
