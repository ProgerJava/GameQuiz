...
import com.example.quiz.databinding.ActivityNormalMathLevel2Binding;
import com.example.quiz.system.ActivityMathematicsNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalMathLevel2 extends BaseActivity {

    private ActivityNormalMathLevel2Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalMathLevel2Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalMathLevel2Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalMathLevel3.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_NORMAL, 2);
