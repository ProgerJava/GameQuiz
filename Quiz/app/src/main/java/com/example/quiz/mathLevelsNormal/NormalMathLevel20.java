...
import com.example.quiz.databinding.ActivityNormalMathLevel20Binding;
import com.example.quiz.system.ActivityMathematicsNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalMathLevel20 extends BaseActivity {

    private ActivityNormalMathLevel20Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalMathLevel20Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalMathLevel20Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, ActivityMathematicsNormal.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_NORMAL, 20);
