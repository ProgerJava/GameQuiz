...
import com.example.quiz.databinding.ActivityNormalPhLevel20Binding;
import com.example.quiz.system.ActivityPhNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalPhLevel20 extends BaseActivity {

    private ActivityNormalPhLevel20Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalPhLevel20Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalPhLevel20Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, ActivityPhNormal.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_NORMAL, 20);
