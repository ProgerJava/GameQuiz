...
import com.example.quiz.databinding.ActivityNormalMathLevel15Binding;
import com.example.quiz.system.ActivityMathematicsNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalMathLevel15 extends BaseActivity {

    private ActivityNormalMathLevel15Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalMathLevel15Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalMathLevel15Ans4, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalMathLevel16.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_NORMAL, 15);
