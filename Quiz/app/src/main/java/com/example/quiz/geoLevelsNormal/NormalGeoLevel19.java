...
import com.example.quiz.databinding.ActivityNormalGeoLevel19Binding;
import com.example.quiz.system.ActivityGeoNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalGeoLevel19 extends BaseActivity {

    private ActivityNormalGeoLevel19Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalGeoLevel19Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalGeoLevel19Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalGeoLevel20.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_NORMAL, 19);
