...
import com.example.quiz.databinding.ActivityNormalPhLevel16Binding;
import com.example.quiz.system.ActivityPhNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalPhLevel16 extends BaseActivity {

    private ActivityNormalPhLevel16Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalPhLevel16Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalPhLevel16Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalPhLevel17.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_NORMAL, 16);
