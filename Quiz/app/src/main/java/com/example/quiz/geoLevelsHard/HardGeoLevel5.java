...
import com.example.quiz.databinding.ActivityHardGeoLevel5Binding;
import com.example.quiz.system.ActivityGeoHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardGeoLevel5 extends BaseActivity {

    private ActivityHardGeoLevel5Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardGeoLevel5Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardGeoLevel5Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardGeoLevel6.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_HARD, 5);
