...
import com.example.quiz.databinding.ActivityHardMathLevel3Binding;
import com.example.quiz.system.ActivityMathematicsHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardMathLevel3 extends BaseActivity {

    private ActivityHardMathLevel3Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardMathLevel3Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardMathLevel3Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardMathLevel4.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_HARD, 3);
