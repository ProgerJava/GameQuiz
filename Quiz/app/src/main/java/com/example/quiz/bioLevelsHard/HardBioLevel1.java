...
import com.example.quiz.databinding.ActivityHardBioLevel1Binding;
import com.example.quiz.system.ActivityBioHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardBioLevel1 extends BaseActivity {

    private ActivityHardBioLevel1Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardBioLevel1Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardBioLevel1Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardBioLevel2.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_BIO_HARD, 1);
