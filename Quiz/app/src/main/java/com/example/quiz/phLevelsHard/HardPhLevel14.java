...
import com.example.quiz.databinding.ActivityHardPhLevel14Binding;
import com.example.quiz.system.ActivityPhHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardPhLevel14 extends BaseActivity {

    private ActivityHardPhLevel14Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardPhLevel14Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardPhLevel14Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardPhLevel15.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_HARD, 14);
