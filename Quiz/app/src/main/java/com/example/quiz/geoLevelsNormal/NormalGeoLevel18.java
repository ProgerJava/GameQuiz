...
import com.example.quiz.databinding.ActivityNormalGeoLevel18Binding;
import com.example.quiz.system.ActivityGeoNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalGeoLevel18 extends BaseActivity {

    private ActivityNormalGeoLevel18Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalGeoLevel18Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalGeoLevel18Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalGeoLevel19.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_NORMAL, 18);
