...
import com.example.quiz.databinding.ActivityHardPhLevel1Binding;
import com.example.quiz.system.ActivityPhHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardPhLevel1 extends BaseActivity {

    private ActivityHardPhLevel1Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardPhLevel1Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardPhLevel1Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardPhLevel2.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_HARD, 1);
