...
import com.example.quiz.databinding.ActivityHardMathLevel10Binding;
import com.example.quiz.system.ActivityMathematicsHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardMathLevel10 extends BaseActivity {

    private ActivityHardMathLevel10Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardMathLevel10Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardMathLevel10Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardMathLevel11.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_HARD, 10);
