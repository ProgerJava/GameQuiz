...
import com.example.quiz.databinding.ActivityNormalMathLevel7Binding;
import com.example.quiz.system.ActivityMathematicsNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalMathLevel7 extends BaseActivity {

    private ActivityNormalMathLevel7Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalMathLevel7Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalMathLevel7Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalMathLevel8.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_NORMAL, 7);
