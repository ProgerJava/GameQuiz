...
import com.example.quiz.databinding.ActivityHardMathLevel20Binding;
import com.example.quiz.system.ActivityMathematicsHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardMathLevel20 extends BaseActivity {

    private ActivityHardMathLevel20Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardMathLevel20Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardMathLevel20Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, ActivityMathematicsHard.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_HARD, 20);
