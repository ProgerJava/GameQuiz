...
import com.example.quiz.databinding.ActivityNormalBioLevel10Binding;
import com.example.quiz.system.ActivityBioNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalBioLevel10 extends BaseActivity {

    private ActivityNormalBioLevel10Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalBioLevel10Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalBioLevel10Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalBioLevel11.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_BIO_NORMAL, 10);
