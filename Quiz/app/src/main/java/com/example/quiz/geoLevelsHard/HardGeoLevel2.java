...
import com.example.quiz.databinding.ActivityHardGeoLevel2Binding;
import com.example.quiz.system.ActivityGeoHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardGeoLevel2 extends BaseActivity {

    private ActivityHardGeoLevel2Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardGeoLevel2Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardGeoLevel2Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardGeoLevel3.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_HARD, 2);
