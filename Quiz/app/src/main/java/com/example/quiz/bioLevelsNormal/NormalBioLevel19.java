...
import com.example.quiz.databinding.ActivityNormalBioLevel19Binding;
import com.example.quiz.system.ActivityBioNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalBioLevel19 extends BaseActivity {

    private ActivityNormalBioLevel19Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalBioLevel19Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalBioLevel19Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalBioLevel20.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_BIO_NORMAL, 19);
