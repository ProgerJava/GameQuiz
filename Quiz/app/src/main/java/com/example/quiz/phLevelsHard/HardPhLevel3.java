...
import com.example.quiz.databinding.ActivityHardPhLevel3Binding;
import com.example.quiz.system.ActivityPhHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardPhLevel3 extends BaseActivity {

    private ActivityHardPhLevel3Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardPhLevel3Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardPhLevel3Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardPhLevel4.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_HARD, 3);
