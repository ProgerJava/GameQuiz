...
import com.example.quiz.databinding.ActivityNormalGeoLevel12Binding;
import com.example.quiz.system.ActivityGeoNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalGeoLevel12 extends BaseActivity {

    private ActivityNormalGeoLevel12Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalGeoLevel12Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalGeoLevel12Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalGeoLevel13.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_NORMAL, 12);
