...
import com.example.quiz.databinding.ActivityNormalPhLevel11Binding;
import com.example.quiz.system.ActivityPhNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalPhLevel11 extends BaseActivity {

    private ActivityNormalPhLevel11Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalPhLevel11Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalPhLevel11Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalPhLevel12.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_NORMAL, 11);
