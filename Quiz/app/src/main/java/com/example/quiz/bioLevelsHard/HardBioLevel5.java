...
import com.example.quiz.databinding.ActivityHardBioLevel5Binding;
import com.example.quiz.system.ActivityBioHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardBioLevel5 extends BaseActivity {

    private ActivityHardBioLevel5Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardBioLevel5Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardBioLevel5Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardBioLevel6.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_BIO_HARD, 5);
