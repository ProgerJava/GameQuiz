...
import com.example.quiz.databinding.ActivityHardPhLevel6Binding;
import com.example.quiz.system.ActivityPhHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardPhLevel6 extends BaseActivity {

    private ActivityHardPhLevel6Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardPhLevel6Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardPhLevel6Ans4, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardPhLevel7.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_HARD, 6);
