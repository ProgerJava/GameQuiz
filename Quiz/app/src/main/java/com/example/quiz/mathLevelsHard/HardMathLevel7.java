...
import com.example.quiz.databinding.ActivityHardMathLevel7Binding;
import com.example.quiz.system.ActivityMathematicsHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardMathLevel7 extends BaseActivity {

    private ActivityHardMathLevel7Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardMathLevel7Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardMathLevel7Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardMathLevel8.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_HARD, 7);
