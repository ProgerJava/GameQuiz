...
import com.example.quiz.databinding.ActivityNormalGeoLevel9Binding;
import com.example.quiz.system.ActivityGeoNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalGeoLevel9 extends BaseActivity {

    private ActivityNormalGeoLevel9Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalGeoLevel9Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalGeoLevel9Ans3, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalGeoLevel10.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_NORMAL, 9);
