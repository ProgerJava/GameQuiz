...
import com.example.quiz.databinding.ActivityNormalPhLevel3Binding;
import com.example.quiz.system.ActivityPhNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalPhLevel3 extends BaseActivity {

    private ActivityNormalPhLevel3Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalPhLevel3Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalPhLevel3Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalPhLevel4.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_PH_NORMAL, 3);
