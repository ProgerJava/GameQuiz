...
import com.example.quiz.databinding.ActivityNormalBioLevel7Binding;
import com.example.quiz.system.ActivityBioNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalBioLevel7 extends BaseActivity {

    private ActivityNormalBioLevel7Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalBioLevel7Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalBioLevel7Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalBioLevel8.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_BIO_NORMAL, 7);
