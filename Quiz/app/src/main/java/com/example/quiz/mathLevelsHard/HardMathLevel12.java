...
import com.example.quiz.databinding.ActivityHardMathLevel12Binding;
import com.example.quiz.system.ActivityMathematicsHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardMathLevel12 extends BaseActivity {

    private ActivityHardMathLevel12Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardMathLevel12Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardMathLevel12Ans4, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardMathLevel13.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_HARD, 12);
