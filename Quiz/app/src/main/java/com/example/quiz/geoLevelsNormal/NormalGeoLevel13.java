...
import com.example.quiz.databinding.ActivityNormalGeoLevel13Binding;
import com.example.quiz.system.ActivityGeoNormal;
import com.example.quiz.ui.activity.BaseActivity;

public class NormalGeoLevel13 extends BaseActivity {

    private ActivityNormalGeoLevel13Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNormalGeoLevel13Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityNormalGeoLevel13Ans1, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, NormalGeoLevel14.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_NORMAL, 13);
