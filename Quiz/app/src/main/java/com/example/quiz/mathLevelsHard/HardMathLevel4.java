...
import com.example.quiz.databinding.ActivityHardMathLevel4Binding;
import com.example.quiz.system.ActivityMathematicsHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardMathLevel4 extends BaseActivity {

    private ActivityHardMathLevel4Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardMathLevel4Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardMathLevel4Ans2, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardMathLevel5.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_MATH_HARD, 4);
