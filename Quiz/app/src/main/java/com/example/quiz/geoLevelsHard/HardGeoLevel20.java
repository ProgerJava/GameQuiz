...
import com.example.quiz.databinding.ActivityHardGeoLevel20Binding;
import com.example.quiz.system.ActivityGeoHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardGeoLevel20 extends BaseActivity {

    private ActivityHardGeoLevel20Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardGeoLevel20Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardGeoLevel20Ans4, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, ActivityGeoHard.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_HARD, 20);
