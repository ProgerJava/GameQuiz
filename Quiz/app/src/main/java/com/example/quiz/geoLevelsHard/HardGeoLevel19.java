...
import com.example.quiz.databinding.ActivityHardGeoLevel19Binding;
import com.example.quiz.system.ActivityGeoHard;
import com.example.quiz.ui.activity.BaseActivity;

public class HardGeoLevel19 extends BaseActivity {

    private ActivityHardGeoLevel19Binding binding;

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityHardGeoLevel19Binding.inflate(getLayoutInflater());
        ...
        binding.answerView.listeners(R.string.activityHardGeoLevel19Ans4, (isCorrect, tv) -> {
            binding.answerView.monitorSetText(isCorrect, tv, HardGeoLevel20.class, (isTrue) -> {
                if(isTrue) incrementCompletedLevelCount(LVL_GEO_HARD, 19);
